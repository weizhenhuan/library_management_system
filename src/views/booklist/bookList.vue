<template>
  <el-main>
    ...
    <el-table :data="tableData"
              border
              stripe
              :header-cell-style="{background:'#F2DC7C',color:'#606266'}">
        ...
        <template v-slot="props">
          <el-form label-position="left"
            ...
            <el-form-item style="position: relative; height: 80px;width: 300px;">
              <el-button type="primary"
                         v-on:click="handleBorrowBook(props.row.bookId, props.row.leftNum)">
              ...
              <el-button type="success"
                         v-on:click="handleBuyBook(props.row.bookId, props.row.leftNum)"
...
<script>
import { getBookByNameAndISBN, borrowBookByID, buyBookByID } from '@/api/book'
...
export default {
  ...
  methods: {
    ...
    handleBorrowBook (bookId, leftNum) {
      ...
      borrowBookByID(bookId, this.$store.getter.token).then()
      /*TODO
      * check book state
      * change book state
      * reload page?
